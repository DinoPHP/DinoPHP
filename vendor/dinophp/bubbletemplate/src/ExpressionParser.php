...
use Bubble\Node\Expression\ArrowFunctionExpression;
...
class ExpressionParser
{
    ...
    private function getTestNodeClass(BubbleTest $test): string
    {
        if ($test->isDeprecated()) {
            $stream = $this->parser->getStream();
            $message = sprintf('Bubble Test "%s" is deprecated', $test->getName());
    ...
    private function getFunctionNodeClass(string $name, int $line): string
    {
        ...
        if ($function->isDeprecated()) {
            $message = sprintf('Bubble Function "%s" is deprecated', $function->getName());
    ...
    private function getFilterNodeClass(string $name, int $line): string
    {
        ...
        if ($filter->isDeprecated()) {
            $message = sprintf('Bubble Filter "%s" is deprecated', $filter->getName());
