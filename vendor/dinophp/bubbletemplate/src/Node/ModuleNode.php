...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use Bubble\Environment;\n")
                ->write("use Bubble\Error\LoaderError;\n")
                ->write("use Bubble\Error\RuntimeError;\n")
                ->write("use Bubble\Extension\SandboxExtension;\n")
                ->write("use Bubble\Markup;\n")
                ->write("use Bubble\Sandbox\SecurityError;\n")
                ->write("use Bubble\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use Bubble\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use Bubble\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use Bubble\Source;\n")
                ->write("use Bubble\Template;\n\n")
            ;
        }
        $compiler
    ...
    protected function compileLoadTemplate(Compiler $compiler, $node, $var)
    {
        if ($node instanceof ConstantExpression) {
            ...
            throw new Exception('Trait templates can only be constant nodes.');
        }
    }
}
