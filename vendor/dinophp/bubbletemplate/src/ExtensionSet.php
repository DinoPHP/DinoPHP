...
use Bubble\Extension\StagingExtension;
...
final class ExtensionSet
{
    ...
    public function addExtension(ExtensionInterface $extension): void
    {
        ...
        if ($this->initialized) {
            throw new Exception(sprintf('Unable to register extension "%s" as extensions have already been initialized.', $class));
        }

        if (isset($this->extensions[$class])) {
            throw new Exception(sprintf('Unable to register extension "%s" as it is already registered.', $class));
        }
    ...
    {
        if ($this->initialized) {
            throw new Exception(sprintf('Unable to add function "%s" as extensions have already been initialized.', $function->getName()));
        }
    ...
    {
        if ($this->initialized) {
            throw new Exception(sprintf('Unable to add filter "%s" as extensions have already been initialized.', $filter->getName()));
        }
    ...
    {
        if ($this->initialized) {
            throw new Exception('Unable to add a node visitor as extensions have already been initialized.');
        }
    ...
    {
        if ($this->initialized) {
            throw new Exception('Unable to add a token parser as extensions have already been initialized.');
        }
    ...
    {
        if ($this->initialized) {
            throw new Exception(sprintf('Unable to add test "%s" as extensions have already been initialized.', $test->getName()));
        }
    ...
    private function initExtension(ExtensionInterface $extension): void
    {
        ...
        foreach ($extension->getTokenParsers() as $parser) {
            if (!$parser instanceof TokenParserInterface) {
                throw new Exception('getTokenParsers() must return an array of \Bubble\TokenParser\TokenParserInterface.');
            }
