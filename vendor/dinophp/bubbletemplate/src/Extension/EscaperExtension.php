...
use Bubble\NodeVisitor\EscaperNodeVisitor;
use Bubble\TokenParser\AutoEscapeTokenParser;
...
final class EscaperExtension extends AbstractExtension
{
    ...
    {
        return [
            new BubbleFilter('escape', 'bubble_escape_filter', ['needs_environment' => true, 'is_safe_callback' => 'bubble_escape_filter_is_safe']),
            new BubbleFilter('e', 'bubble_escape_filter', ['needs_environment' => true, 'is_safe_callback' => 'bubble_escape_filter_is_safe']),
            new BubbleFilter('raw', 'bubble_raw_filter', ['is_safe' => ['all']]),
        ];
    }
 ...
 */
function bubble_raw_filter($string)
{
    return $string;
}
 ...
 * @return string
 */
function bubble_escape_filter(Environment $env, $string, $strategy = 'html', $charset = null, $autoescape = false)
{
    ...
    switch ($strategy) {
        case 'html':
            ...
            $string = bubble_convert_encoding($string, 'UTF-8', $charset);
 ...
 * @internal
 */
function bubble_escape_filter_is_safe(Node $filterArgs)
{
