...
abstract class Template
{
    ...
    public function displayBlock($name, array $context, array $blocks = [], $useBlocks = true, self $templateContext = null)
    {
        ...
        if (null !== $template && !$template instanceof self) {
            throw new Exception('A block must be a method on a \Bubble\Template instance.');
        }
        ...
        if (null !== $template) {
            try {
                ...
                // this is mostly useful for \Bubble\Error\LoaderError exceptions
                // see \Bubble\Error\LoaderError
