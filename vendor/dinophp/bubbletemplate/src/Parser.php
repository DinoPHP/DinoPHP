...
use Bubble\Node\NodeCaptureInterface;
use Bubble\Node\NodeOutputInterface;
...
class Parser
{
    ...
    private function filterBodyNodes(Node $node, bool $nested = false): ?Node
    {
        ...
        if (
            ...
            throw new SyntaxError('A template that extends another one cannot include content outside Bubble blocks. Did you forget to put the content inside a {% block %} tag?', $node->getTemplateLine(), $this->stream->getSourceContext());
        }
